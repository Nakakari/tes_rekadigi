            ...
            <div class="main-container container-fluid">
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div class="left-content">
                        <span class="main-content-title mg-b-0 mg-b-lg-1">DETAIL KEGIATAN</span>
                    </div>
                    <div class="justify-content-center mt-2">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item tx-15"><a href="javascript:void(0);">DETAIL KEGIATAN</a></li>
                            ...
                            <div class="card overflow-hidden">
                                <div class="card-body" style="text-align: center;">
                                    <a href="javascript:void(0);">
                                        <h5 class="font-weight-semibold">{{ $kegiatan->judul }}</h5>
                                    </a>
                                </div>
                                <div class="item7-card-img px-4 pt-4">
                                    <a href="javascript:void(0);"></a>
                                    @foreach ($kegiatan->get_dokumen as $news)
                                        <img src="{{ asset('/dokumen/kegiatan/' . $news->nama) }}" alt="img"
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="">{{ $kegiatan->deskripsi }}</p>
                                </div>
                                <div class="card-footer pb-2 pt-2">
                                    <div class="item7-card-desc d-md-flex">
                                        <div class="d-flex align-items-center mt-0">
                                            <img alt="{{ $kegiatan->get_user->image }}"
                                                src="{{ asset('/imageprofil/' . $kegiatan->get_user->image) }}"
                                                class="avatar brround avatar-md me-3" alt="avatar-img">
                                            <div>
                                                <a href="profile.html"
                                                    class="text-default font-weight-bold">{{ $kegiatan->get_user->name }}</a>
                                        ...
                                        <div class="ms-auto mb-2 d-flex mt-3">
                                            <a href="javascript:void(0);" class="me-3 mb-2 me-2 d-flex"><span
                                                ...
                                                <div class="mt-0 mt-0 text-dark"> {{ $kegiatan->created_at }}</div>
                                            </a>
                                            <a class="me-0 d-flex"
                                                href="{{ url('kegiatan/komentar/' . base64_encode($id)) }}"><span
