                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ url('/kegiatan/addThumbnail/' . base64_encode($id)) }}" id="formData"
                                    method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label class="main-content-label tx-11 tx-medium tx-gray-600">Activity's
                                            Title</label>
                                        <input class="form-control" type="text" name="judul" id="judul"
                                            value="{{ $kegiatan->judul }}" disabled>
                                    </div>
                                    ...
                                    @foreach ($kegiatan->get_dokumen as $activity)
                                        <div class="row row-sm">
                                            <div class="col-lg-1">
                                                <label class="rdiobox">
                                                    <input name="thumbnail" type="radio" value="{{ $activity->id }}">
                                                    <span></span>
                                                </label>
                                            </div>
                                            <div class="col-lg-11">
                                                <embed src="{{ asset('/dokumen/kegiatan/' . $activity->nama) }}"
                                                    type="application/pdf" width="100%" height="150px"></embed>
                                            </div>
                                        </div>
                                    @endforeach
