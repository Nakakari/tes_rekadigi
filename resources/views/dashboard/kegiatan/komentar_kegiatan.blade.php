                            ...
                            <div class="card-body pt-0 example1-table">
                                <div class="">
                                    <div class="card overflow-hidden">
                                        <div class="card">
                                            <div class="card-body">
                                                @include('dashboard.kegiatan.komentar_reply', ['comments' => $kegiatan->comments,'id_kegiatan' => $kegiatan->id])
                                                <br />
                                                <form method="post" action="{{ route('kegiatan.comment.store') }}">
                                                    @csrf
                                                    <div class="form-group">
                                                        <textarea class="form-control" name="komentar" rows="2" placeholder="Write Comment"></textarea>
