        ...
        <div class="main-content app-content">
            ...
            <div class="main-container container-fluid">
                                            ...
                                            <div class="col-xl-9 col-lg-7 col-md-6 col-sm-12">
                                                <div class="text-justified align-items-center">
                                                    <h3 class="text-dark font-weight-semibold mb-2 mt-0">Hi, Selamat
                                                        Datang <span class="text-primary">{{ Auth()->user()->name }}</span></h3>
                ...
                <div class="row row-sm">
                                ...
                                <div class="col-8">
                                    <div class="ps-4 pt-4 pe-3 pb-4">
                                        ...
                                        <div class="pb-0 mt-0">
                                            ...
                                            <p class="mb-0 tx-12 text-muted">Role<i class="fa fa-caret-up mx-2 text-success"></i>
                                ...
                                <div class="col-8">
                                    <div class="ps-4 pt-4 pe-3 pb-4">
                                        ...
                                        <div class="pb-0 mt-0">
                                            ...
                                            <p class="mb-0 tx-12 text-muted">User<i class="fa fa-caret-down mx-2 text-danger"></i>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
                        <div class="card sales-card circle-image4 card bg-warning-gradient text-white">
                            <div class="row">
                                <div class="col-8">
                                    <div class="ps-4 pt-4 pe-3 pb-4">
                                        <div class="">
                                            <h6 class="mb-2 tx-14">Total Kegiatan</h6>
                                        </div>
                                        <div class="pb-0 mt-0">
                                            <div class="d-flex">
                                            ...
                                            <p class="mb-0 tx-12  text-muted">Kegiatan dari Mitra
                                                <!-- <i class="fa fa-caret-down mx-2 text-danger"></i> -->
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
                        <div class="card sales-card circle-image4 card bg-pink-gradient text-white">
                            <div class="row">
                                <div class="col-8">
                                    <div class="ps-4 pt-4 pe-3 pb-4">
                                        <div class="">
                                            <h6 class="mb-2 tx-14">Total Berita</h6>
                                        </div>
                                        <div class="pb-0 mt-0">
                                            <div class="d-flex">
                                                <h4 class="tx-22 font-weight-semibold mb-2">{{ $total_berita }}
                                                </h4>
                                            </div>
                                            <p class="mb-0 tx-12  text-muted">Berita dari Mitra<i class="fa fa-caret-down mx-2 text-danger"></i>
                                                <span class="text-danger font-weight-semibold"> </span>
                                            </p>
                                        </div>
                                    </div>
