<!-- row -->
<div class="row row-sm" style="margin-left: 2px;margin-right:2px" style="margin-left: 2px;margin-right:2px">
...
<!-- row -->
<div class="row row-sm" style="margin-left: 2px;margin-right:2px">
    <div class="col-sm-12 col-md-6">
        <div class="card overflow-hidden">
            <div class="card-body">
                <div class="main-content-label mg-b-5">
