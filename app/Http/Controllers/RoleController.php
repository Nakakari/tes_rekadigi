...
class RoleController extends Controller
{
    public function __construct()
    {
        ...
        $this->tabelRole =  Role::all();
        $this->roleAssignment = RoleAssignment::all();
    }
    /**
    ...
    public function index()
    {
        ...
        return view('pengaturan.roles.index', [
            'role' => Role::all(), 'userrole' =>  $Usernya->join(), 'namerole' => $Usernya->namarole(),
            'tabelRole' => $this->tabelRole, 'roleAssignment' => $this->roleAssignment
        ]);
    ...
    public function create()
    {
        ...
        return view('pengaturan.roles.create', [
            'authorities' => config('permission.authorities'), 'tabelRole' => $this->tabelRole,
