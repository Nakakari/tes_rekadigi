                                        ...
                                        <div class="form-group hdtuto increment">
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    ...
                                                    <select onchange="ShowHideDiv()" id="tambahselect" class="js-example-basic-multiple" name="role[]" id="role[]" style="width: 100%;height: 100%;color:#a09e9e;background:#00000000;border:1px solid #f1f1f1">
